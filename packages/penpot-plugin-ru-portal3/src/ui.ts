...
const DEFAULT_TOKENS_URL = 'https://thiagoprazeres-ufpe.github.io/design-system-ufpe/submarcas/ru-portal3/tokens/tokens.penpot.json';

ui.innerHTML = `
  <h1>RU Portal3 Design System</h1>
