  ...
  render(root) {
    root.append(
      ...
      h('section', {},
        ...
        h('h3', {}, 'CSS direto'),
        CodeBlock({ language: 'css', code: "@import '@sti-ufpe/tokens/css';\n\n.botao {\n  background: var(--color-brand-primary);\n  color: var(--color-brand-contrast);\n  padding: var(--space-2) var(--space-3);\n  font-family: var(--font-family-sans);\n}" }),
        h('h3', {}, 'JavaScript / ESM'),
        CodeBlock({ language: 'js', code: "import { tokens } from '@sti-ufpe/tokens';\n\ntokens.color.brand.primary; // '#990000'\ntokens.mark.ratio.height;   // 1.5" }),
      ),
      h('section', {},
        h('h2', {}, 'Stack'),
        h('table', {},
          ...
          h('tbody', {},
            ...
            h('tr', {}, h('td', {}, 'Sincronização'),         h('td', {}, h('code', {}, '@sti-ufpe/penpot-plugin'), ' — push/pull bidirecional')),
